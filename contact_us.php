...
<!-- Mirrored from preview.templatehouse.net/getfund/contact_us.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jun 2019 05:17:34 GMT -->
...
<head>
    ...
    <title>Contact Us - ProjectFund</title>
</head>
...
<body>
    ...
    <section class="contact-pg-section pt60 pb60">
        <div class="container">
            <div class="row">
                <div class=" col-lg-7 col-md-6 col-sm-12">
                    <div class="section-title-s4">
                        <h2>Get In Touch</h2>
                        <p>Drop a message below and we will get back to you within 24 hours.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <form method="post" action="https://formspree.io/ka1044@live.mdx.ac.uk" class="contact-validation-active" id="contact-form-main" novalidate="novalidate">
                        <div>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <div class="contact-info">
                        ...
                        <div>
                            ...
                            <div class="details">
                                <h5>Find us</h5>
                                <p>Student Life Residences, Flic en Flac - Mauritius</p>
                            </div>
                        </div>
                    </div>
                </div>
