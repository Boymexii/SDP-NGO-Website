...
<?php 
	$con = mysqli_connect("localhost","root","root","ngo") or die("Error in connecting");
	...
	if(isset($_POST['submit'])){
		 ...
		 $recommended_amount = $_POST['recommended_amount'];
		 $end_method = $_POST['end_method'];
		 $country = $_POST['country'];
		 $start_date = $_POST['start_date'];
		 $end_date = $_POST['end_date'];
		
		if($category=='' OR $title=='' OR $short_description==''){
		...
		$insert_query = "insert into campaign (category,title,fullname,short_description,description,recommended_amount,end_method,country,start_date,end_date) values ('$category','$title','$fullname','$short_description','$description','$recommended_amount','$end_method','$country','$start_date','$end_date')";
			
		if(mysqli_query($con,$insert_query)){
		
		echo "<script>alert('Your campaign has been submitted successfully')</script>";
...
<head>
    ...
    <title>Create a Campaign - ProjectFund</title>
</head>
    ...
    <div class="limiter campaign_create pt50 pb50">
        <div class="container-login100">
            <div class="wrap-login100">
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="startCampaignForm" class="form-horizontal" enctype="">
                    <?php
                    ...
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label">Category <span class="field-required">*</span></label>
                        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">Title *</span></label>
                        <div class="col-md-12">
                            <input type="text" class="form-control" value="" name="title" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">Full Name *</span></label>
                        <div class="col-md-12">
                            <input type="text" class="form-control" value="<?php echo $_SESSION['usr_fullname']; ?>" name="fullname" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">Short Description *</span></label>
                        <div class="col-md-12">
                            <textarea name="short_description" class="form-control" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">Description *</span></label>
                        <div class="col-md-12">
                            <textarea name="description" class="form-control" rows="4"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">Recommended Amount *</span></label>
                        <div class="col-md-12">
                            <input type="number" class="form-control" value="" name="recommended_amount" placeholder="">
                        </div>
                    </div>
                    <?php
                        //Connect to our MySQL database using the PDO extension.
                        $pdo = new PDO('mysql:host=localhost;dbname=ngo', 'root', 'root');
                        //Our select statement. This will retrieve the data that we want.
                        $sql = "SELECT id, method FROM end_method";
                        //Prepare the select statement.
                        $stmt = $pdo->prepare($sql);
                        //Execute the statement.
                        $stmt->execute();
                    ...
                    ?>
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label">End Method <span class="field-required">*</span></label>
                        <div class="col-md-12">
                            <select class="form-control select2" name="end_method">
                    ...
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">Country *</span></label>
                        <div class="col-md-12">
                            <input type="text" class="form-control" value="" name="country" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">Start Date</span></label>
                        <div class="col-md-12">
                            <input type="date" class="form-control" value="" name="start_date" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="category" class="col-md-12 control-label"> <span class="field-required">End Date</span></label>
                        <div class="col-md-12">
                            <input type="date" class="form-control" value="" name="end_date" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <button type="submit" name="submit" class="btn btn-primary">Submit new campaign</button>
                        </div>
                    </div>
                </form>
            </div>
